...
return new class extends Migration
{
    public function up()
    {
        ...
        DB::table('products')->insert([
            ...
            ['name' => 'Whipped Cream', 'src' =>'images/whipped.png', 'type' => 'I', 'category' => 'TOP', 'current_price' => 0.3, 'unit' => 30],
            ['name' => 'Chocolate Syrup', 'src' => 'images/ChocholateSyr.png', 'type' => 'I', 'category' => 'SYR', 'current_price' => 0.5, 'unit' => 20],
            ...
            ['name' => 'Cinnamon Syrup', 'src' => 'images/cinamonSyr.png', 'type' => 'I', 'category' => 'SYR', 'current_price' => 0.5, 'unit' => 10],
            ['name' => 'Vanilla Syrup', 'src' => 'images/VanilliaSyr.png', 'type' => 'I', 'category' => 'SYR', 'current_price' => 0.5, 'unit' => 20],
            ['name' => 'Coconut Syrup', 'src' => 'images/coconutSyr.png', 'type' => 'I', 'category' => 'SYR', 'current_price' => 0.5, 'unit' => 20],
            ['name' => 'Lavender Syrup', 'src' => 'images/levanderSyr.png', 'type' => 'I', 'category' => 'SYR', 'current_price' => 0.8, 'unit' => 10],
            ['name' => 'Chai Tea', 'src' => 'images/chaiTea.png', 'type' => 'I', 'category' => 'BAS', 'current_price' => 2.3, 'unit' => 20],
            ['name' => 'Peach Tea Bag', 'src' => 'images/peachTea.png', 'type' => 'I', 'category' => 'COR', 'current_price' => 1.5, 'unit' => 1],
        ...
        DB::table('products')->insert([
            ['name' => 'Espresso Coffee', 'src' =>'images/espressoIngredient.png', 'type' => 'I', 'category' => 'BAS', 'current_price' => 2, 'unit' => 30],
            ['name' => 'Ice', 'src' => null, 'type' => 'I', 'category' => 'ICE', 'current_price' => 0, 'unit' => 200],
            ['name' => 'Caramel Syrup', 'src' => 'images/caramellSyr.png', 'type' => 'I', 'category' => 'SYR', 'current_price' => 0.5, 'unit' => 20],
            ['name' => 'Vanilla Ice Cream', 'src' => 'images/vanillia.png', 'type' => 'I', 'category' => 'TOP', 'current_price' => 0.5, 'unit' => 100],
            ['name' => 'Turmeric Powder', 'src' => 'images/turmericPow.png', 'type' => 'I', 'category' => 'BAS', 'current_price' => 2.7, 'unit' => 2],
            ...
            ['name' => 'Green Tea Bag', 'src' =>'images/greenTea.png', 'type' => 'I', 'category' => 'COR', 'current_price' => 1.2, 'unit' => 1],
            ['name' => 'Almond Milk', 'src' => 'images/almondMilk.png', 'type' => 'I', 'category' => 'MIL', 'current_price' => 0.3, 'unit' => 100],
            ['name' => 'Oat Milk', 'src' => 'images/OatMilk.png', 'type' => 'I', 'category' => 'MIL', 'current_price' => 0.3, 'unit' => 100],
